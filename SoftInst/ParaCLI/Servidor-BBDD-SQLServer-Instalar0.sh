...
# ----------
#  Script de NiPeGun para instalar y configurar SQLServer en Ubuntu
#
#  Ejecución remota:
...
if [ $vVersUbuntu == "trusty" ]; then
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Iniciando el script de instalación de SQLServer para Ubuntu 14.04 LTS (Trusty Tahr)...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Iniciando el script de instalación de SQLServer para Ubuntu 16.04 LTS (Xenial Xerus)...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Iniciando el script de instalación de SQLServer para Ubuntu 18.04 LTS (Bionic Beaver)...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Iniciando el script de instalación de SQLServer para Ubuntu 20.04 LTS (Focal Fossa)...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Iniciando el script de instalación de SQLServer para Ubuntu 22.04 LTS (Jammy Jellyfish)...${vFinColor}"
  echo ""
