...
#          echo "x11vnc -noxdamage -many -display :0 -auth /var/run/gdm/$(sudo ls /var/run/gdm | grep $(whoami))/database -forever -bg -passwd Pass123"                                                       >> /etc/systemd/system/x11vnc.service
